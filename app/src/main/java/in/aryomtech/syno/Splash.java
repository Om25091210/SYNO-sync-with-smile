...
public class Splash extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mList.add(new ScreenItem("Get to know our college","About our teachers, students, clubs and activities.",R.drawable.ic_onboarding_one));
        mList.add(new ScreenItem("Find Like-Minded People","Connect with people with similar interests and hobbies.",R.drawable.ic_onboarding_two));
        mList.add(new ScreenItem("Get Inspired","Take inspiration as well as share your own experiences",R.drawable.ic_onboarding_three));
        // setup viewpager
    ...
    protected void onStart() {
        ...
        boolean is_opened_interest=getSharedPreferences("Open_once_interest101",MODE_PRIVATE)
        ...
        if(user!=null){
            if(is_authorized){
                if(is_opened_interest){
                    ...
                    Intent mainActivity = new Intent(getApplicationContext(),interested_topic.class );
                    startActivity(mainActivity);
                    finish();
                }
            }
            else{
                Intent mainActivity = new Intent(getApplicationContext(),EnterCode.class );
                startActivity(mainActivity);
                finish();
            }
